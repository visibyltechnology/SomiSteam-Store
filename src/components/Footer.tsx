  ...
  return (
    <footer className="bg-navy text-primary-foreground/70 overflow-hidden">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <motion.div variants={itemVariants}>
            <div className="flex items-center gap-2 mb-4">
              <img src={somisteamLogo} alt="SomiSteam Ventures Ltd." className="h-10 w-auto object-contain" />
            </div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="flex flex-col gap-3">
              {[
                { icon: Phone, text: "+234 800 SOMISTEAM" },
                { icon: Mail, text: "info@somisteam.com" },
        ...
        >
          <p>&copy; {new Date().getFullYear()} SomiSteam Ventures Ltd. All rights reserved.</p>
        </motion.div>
      </motion.div>
    </footer>
  );
